...
export default {
  "app.vue": () => import('./_nuxt/app-styles.CPFrIIoH.mjs').then(interopDefault),
  "app.vue?vue&type=style&index=0&lang.css": () => import('./_nuxt/app-styles.CPFrIIoH.mjs').then(interopDefault),
