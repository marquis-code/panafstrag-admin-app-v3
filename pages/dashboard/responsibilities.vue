...
<template>
  <div class="space-y-8 pb-12">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-gray-200 pb-8">
      <div>
        <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Responsibilities</h1>
        <p class="text-gray-500 mt-2 text-sm font-medium">
          Manage the core responsibilities and operational mandates of the institution.
        </p>
      </div>
      <button 
        @click="openCreate" 
