...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h1 class="text-3xl font-black tracking-tight">Create Account</h1><p class="text-slate-500 text-sm font-bold mt-2">Join the Panafstrag network</p></div><form class="space-y-6"><div><label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2 ml-1">Full Name</label><input${ssrRenderAttr("value", unref(form).name)} type="text" required placeholder="John Doe" class="w-full px-6 py-4 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl focus:ring-2 focus:ring-indigo-600 outline-none transition-all font-medium"></div><div><label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2 ml-1">Email Address</label><input${ssrRenderAttr("value", unref(form).email)} type="email" required placeholder="name@example.com" class="w-full px-6 py-4 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl focus:ring-2 focus:ring-indigo-600 outline-none transition-all font-medium"></div><div><label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2 ml-1">Password</label><input${ssrRenderAttr("value", unref(form).password)} type="password" required placeholder="••••••••" class="w-full px-6 py-4 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl focus:ring-2 focus:ring-indigo-600 outline-none transition-all font-medium"></div>`);
      if (unref(error)) {
...
//# sourceMappingURL=register-RRJ9SqFX.mjs.map
